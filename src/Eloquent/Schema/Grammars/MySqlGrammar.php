<?php namespace WeDevs\ORM\Eloquent\Schema\Grammars;
...
class MySqlGrammar extends Grammar {
	 ...
	 * @return string
	 */
	public function compileCreate(Blueprint $blueprint, Fluent $command, $connection)
	{
	 ...
	 * @return string
	 */
	protected function compileCreateEncoding($sql, $connection)
	{
		$sql .= ' ' . $connection->db->get_charset_collate();
