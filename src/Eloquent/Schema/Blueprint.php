...
namespace WeDevs\ORM\Eloquent\Schema;

use Closure;
use Illuminate\Support\Fluent;
use WeDevs\ORM\Eloquent\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     * @return void
     */
    public function build($connection, Grammar $grammar)
    {
        foreach ($this->toSql($connection, $grammar) as $statement) {
            $connection->db->query($statement);
        }
    }
     ...
     * @return array
     */
    public function toSql($connection, Grammar $grammar)
    {
